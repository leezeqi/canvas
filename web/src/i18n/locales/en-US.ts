export default {
    ...
    auth: {
        ...
        loginDescription: "Sign in to continue to your creative workspace.",
        registerDescription: "Create an independent Canvas account with your email.",
        name: "Name (optional)",
        ...
        or: "or",
        continueWithHajimi: "Continue with Hajimi",
        hajimiDescription: "Identity is confirmed by Hajimi without sharing your password or long-lived tokens.",
        hajimiUnavailable: "Hajimi sign-in is not configured",
        hajimiInvalidUrl: "The Hajimi sign-in URL is invalid",
        hajimiSigningIn: "Completing sign-in",
        hajimiSigningInDescription: "You will return to Canvas after your identity is confirmed.",
        hajimiLoginFailed: "Hajimi sign-in failed",
        hajimiTicketMissing: "The sign-in ticket is missing. Start the sign-in flow again.",
        hajimiExchangeFailed: "The sign-in ticket could not be exchanged. Sign in again.",
