export default {
    ...
    auth: {
        ...
        loginTitle: "欢迎回来",
        registerTitle: "创建账号",
        loginDescription: "登录后继续进入你的创作工作台。",
        registerDescription: "使用邮箱创建一个独立的画布账号。",
        name: "昵称（选填）",
        ...
        or: "或",
        continueWithHajimi: "使用 Hajimi 账号继续",
        hajimiDescription: "将在 Hajimi 完成身份确认，不会共享密码或长期 Token。",
        hajimiUnavailable: "Hajimi 登录暂未配置",
        hajimiInvalidUrl: "Hajimi 登录地址配置无效",
        hajimiSigningIn: "正在完成登录",
        hajimiSigningInDescription: "身份确认完成后将自动返回画布。",
        hajimiLoginFailed: "Hajimi 登录失败",
        hajimiTicketMissing: "登录凭证缺失，请重新发起登录。",
        hajimiExchangeFailed: "登录凭证兑换失败，请重新登录。",
        backToLogin: "返回登录",
        restoring: "正在恢复登录状态",
